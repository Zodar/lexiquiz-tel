...
public class AmisForum extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_for_create = (Button) findViewById(R.id.btn_buttonOne);
        Button btn_for_change = (Button) findViewById(R.id.btn_buttonTwo);
        Button btn_for_remove = (Button) findViewById(R.id.btn_buttonThree);
